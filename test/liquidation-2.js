...
describe("Liquidation question 2", function () {
  ...
  it("2,000 USDT liquidate", async function () {
    console.log(
      "\n\n**************************** Start 2,000 USDT liquidation ****************************"
    );
    ...
    console.log(
      `Benefit of used 2,000 USDT after liquidation : `,
  ...
  it("5000 USDT liquidate", async function () {
    console.log(
      "\n\n**************************** Start 5,000 USDT liquidation ****************************"
    );
    await network.provider.request({
      method: "hardhat_reset",
      params: [
    ...
    const profit = afterLiquidationBalance.sub(beforeLiquidationBalance);
    console.log(
      `Benefit of used 5,000 USDT after liquidation : `,
      utils.formatEther(profit),
      "ETH"
    );
  ...
  it("liquidate with 10,000 USDT (transaction reverted)", async function () {
    console.log(
      "\n\n**************************** Start 10,000 USDT liquidation ****************************"
    );
    await network.provider.request({
      method: "hardhat_reset",
      params: [
